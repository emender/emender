-- Test100Passes1Fail.lua - check that graphs are rendered correctly.
...
--
function Test100Passes1Fail.testA()
    -- call pass() 100 times
    for i = 1, 100 do
        pass("Pass#" .. i)
    end
...
--
function Test100Passes1Fail.testB()
    -- call fail() once
    fail("Failure")
    -- call pass() 100 times
    for i = 1, 100 do
...
--
function Test100Passes1Fail.testC()
    -- call pass() 50 times
    for i = 1, 50 do
        pass("Pass#" .. i)
    end
