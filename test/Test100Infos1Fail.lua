-- Test100Infos1Fail.lua - check that graphs are rendered correctly.
...
--
function Test100Infos1Fail.testA()
    -- call pass() 100 times
    for i = 1, 100 do
        warn("Info#" .. i)
    end
...
--
function Test100Infos1Fail.testB()
    -- call fail() once
    fail("Failure")
    -- call pass() 100 times
    for i = 1, 100 do
...
--
function Test100Infos1Fail.testC()
    -- call pass() 50 times
    for i = 1, 50 do
        warn("Info#" .. i)
    end
