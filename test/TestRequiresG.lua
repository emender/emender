-- TestRequiresG.lua - check if all required tools are available.
...
-- Tear down function.
--
function TestRequiresG.tearDown()
    pass("TestRequiresG.tearDown()")
end
...
--
function TestRequiresG.testA()
    pass("TestRequiresG.testA()")
end
