-- TestRequiresI.lua - check if all required tools are available.
...
-- Tear down function.
--
function TestRequiresI.tearDown()
    pass("TestRequiresI.tearDown()")
end
...
--
function TestRequiresI.testA()
    pass("TestRequiresI.testA()")
end
