-- TestRequiresK.lua - check if all required tools are available.
...
-- Tear down function.
--
function TestRequiresK.tearDown()
    pass("TestRequiresK.tearDown()")
end
...
--
function TestRequiresK.testA()
    pass("TestRequiresK.testA()")
end
