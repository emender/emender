-- TestModuleGendoc.lua - check the API for the Emender module 'gendoc'.
...
--
function TestModuleGendoc.doesFunctionExist(functionName)
...
--
function TestModuleGendoc.testFunctionReportError()
    TestModuleGendoc.doesFunctionExist("report_error")
end
