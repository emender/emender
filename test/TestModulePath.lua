-- TestModulePath.lua - check the API for the Emender module 'gendoc'.
...
--
-- Check if the following global module exists: 'path'.
--
function TestModulePath.testModuleExistence()
    TestModulePath.doesModuleExist("path")
end
