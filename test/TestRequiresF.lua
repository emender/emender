-- TestRequiresF.lua - check if all required tools are available.
...
-- Tear down function.
--
function TestRequiresF.tearDown()
    pass("TestRequiresF.tearDown()")
end
...
--
function TestRequiresF.testA()
    pass("TestRequiresF.testA()")
end
