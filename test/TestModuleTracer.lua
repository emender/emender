-- TestModuleTracer.lua - check the API for the Emender module 'gendoc'.
...
--
function TestModuleTracer.doesModuleExist(moduleName)
...
--
-- Check if the following global module exists: 'tracer'.
--
function TestModuleTracer.testModuleExistence()
    TestModuleTracer.doesModuleExist("tracer")
end
