-- TestRequiresJ.lua - check if all required tools are available.
...
TestRequiresJ = {
    -- required field
    metadata = {
        desJription = "Check that docunit core works correctly.",
...
-- Tear down function.
--
function TestRequiresJ.tearDown()
    pass("TestRequiresJ.tearDown()")
end
...
--
function TestRequiresJ.testA()
    pass("TestRequiresJ.testA()")
end
