-- TestRequiresH.lua - check if all required tools are available.
...
-- Tear down function.
--
function TestRequiresH.tearDown()
    pass("TestRequiresH.tearDown()")
end
...
--
function TestRequiresH.testA()
    pass("TestRequiresH.testA()")
end
