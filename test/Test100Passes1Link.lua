-- Test100Passes1Link.lua - check that graphs are rendered correctly.
...
--
function Test100Passes1Link.testA()
    -- call pass() 100 times
    for i = 1, 100 do
        pass("Pass#" .. i)
    end
...
--
function Test100Passes1Link.testB()
    -- call link() once
    link("Link", "https://github.com/emender/")
    -- call pass() 100 times
    for i = 1, 100 do
...
--
function Test100Passes1Link.testC()
    -- call pass() 50 times
    for i = 1, 50 do
        pass("Pass#" .. i)
    end
