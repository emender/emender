-- TestRequiresC.lua - check if all required tools are available.
...
-- Set up function.
--
function TestRequiresC.setUp()
    pass("TestRequiresC.setUp()")
end
...
--
function TestRequiresC.testA()
    pass("TestRequiresC.testA()")
end
