-- TestRequiresB.lua - check if all required tools are available.
...
-- Set up function.
--
function TestRequiresB.setUp()
    pass("TestRequiresB.setUp()")
end
...
--
function TestRequiresB.testA()
    pass("TestRequiresB.testA()")
end
