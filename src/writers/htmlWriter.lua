...
function htmlWriter.writeOverallResults(fout, results, passedTests, failedTests)
    fout:write("</ul>\n\n")
...
function htmlWriter.writeTestName(fout, results, testName)
...
function htmlWriter.writeTestSummary(fout, results, testName, test)
...
function htmlWriter.writeTestFunctionName(fout, results, testName, functionName)
    fout:write("        <li class='method'>\n")
    fout:write("            <h3>" .. functionName .. "</h3>\n")
    fout:write("            <ul>\n")
end

function htmlWriter.writeTestEnd(fout, results, testName)
    fout:write("            </ul>\n")
    fout:write("        </li>\n")
end
